...
dead_list = ["003", "020", "023", '024', '025', '026', '027', '028', '029', '030', '031', '032', '033', "034",
             ...
             "0917", "1428"]
found_list = ['001', '002', '004', '005', '006', '007', '008', '009', '010', '011', '012', '013', '014', '015',
...
for index in found_list:
    df.loc[df['index'] == index, 'statut'] = "Found"

counter_dead = len(dead_list)
counter_found = len(found_list)
total = counter_dead + counter_found
...
fig_map = px.scatter_mapbox(df,
                            ...
                            zoom=10,
                            title=f"Dead {counter_dead} / Found {counter_found} / Total {total}",
